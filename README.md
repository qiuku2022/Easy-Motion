...
Windows x64 安装包 **v0.1.2** 预发行版（未签名，SmartScreen 可能提示）：

- 本地构建产物：`apps/electron/release/EasyMotion-Setup-0.1.2.exe`
...
| 产物 | 路径 |
|------|------|
| 安装程序 | `apps/electron/release/EasyMotion-Setup-0.1.2.exe` |
