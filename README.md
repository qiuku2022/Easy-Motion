...
Windows x64 安装包 **v0.1.0-pre.1**（未签名，SmartScreen 可能提示）：

- **百度网盘：** [EasyMotion-Setup-0.1.0.exe](https://pan.baidu.com/s/1IszD8X-GDhq-hjcH9cN0Lg?pwd=ncwr) · 提取码 `ncwr`
...
| 产物 | 路径 |
|------|------|
| 安装程序 | `apps/electron/release/EasyMotion-Setup-0.1.0.exe` |
