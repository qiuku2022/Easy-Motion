...
export function RveEndCard(props: RveBaseProps = {}) {
  const title = pText(props, "title", "Thanks for Watching");
  const subtitle = pText(props, "subtitle", "Subscribe for More");
  const text = pText(props, "text", "STUDIO CREATIVE");
  ...
  const socialColors = ["#3b82f6", primaryColor, "#7209b7", "#9333ea"];
