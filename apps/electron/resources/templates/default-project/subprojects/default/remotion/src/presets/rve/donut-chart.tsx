...
import { type RveBaseProps, pText, pNum, pColor } from "./shared";

export function RveDonutChart(props: RveBaseProps = {}) {
  const title = pText(props, "title", "Completion Rate");
  const progress = pNum(props, "progress", 78);
  ...
  const segments = [
    { label: "Completed", value: 40, color: primaryColor },
  ...
  const centerValue = Math.round(
    interpolate(frame, [10, 50], [0, progress], {
  ...
  return (
    <div
      style={{
        ...
        background: `linear-gradient(to bottom right, ${backgroundColor}, #1f2937)`,
      }}
    >
      <div
        style={{
