...
export function RveChartAnimation(props: RveBaseProps = {}) {
  const title = pText(props, "title", "Monthly Performance");
  const subtitle = pText(props, "subtitle", "Data visualization for 2023");
