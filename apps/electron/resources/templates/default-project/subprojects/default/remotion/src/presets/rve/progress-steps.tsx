...
import { type RveBaseProps, pText, pCsv, pColor } from "./shared";

export function RveProgressSteps(props: RveBaseProps = {}) {
  const title = pText(props, "title", "Project Timeline");
  const text = pCsv(props, "text", ["Research","Design","Build","Launch"]);
  ...
  return (
    <div
      style={{
        width: "100%",
        height: "100%",
        background: `linear-gradient(180deg, ${backgroundColor}, #1f2937)`,
        display: "flex",
              ...
              >
                <div
                  style={{
                    ...
                    height: "48px",
                    borderRadius: "50%",
                    border: `3px solid ${fillProgress > 0 ? primaryColor : "#4b5563"}`,
                    background:
                      fillProgress > 0
