...
import { type RveBaseProps, pCsv, pColor } from "./shared";

export function RveAnimatedList(props: RveBaseProps = {}) {
  const text = pCsv(props, "text", ["Item One","Item Two","Item Three"]);
  ...
  // Sample list items
  const items = [
    { name: "Item One", color: primaryColor },
