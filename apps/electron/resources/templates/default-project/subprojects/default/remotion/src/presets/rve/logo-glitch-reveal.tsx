...
export function RveLogoGlitchReveal(props: RveBaseProps = {}) {
  const title = pText(props, "title", "LOGO");
  const subtitle = pText(props, "subtitle", "Company Name");
  const text = pText(props, "text", "Your tagline here");
