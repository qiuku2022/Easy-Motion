 ...
 * Source: docs/src/bits/examples/scene-3d/Transform3DShowcase.tsx
 */
...
export function BitsTransform3dShowcase(_props: Record<string, unknown> = {}) {
      ...
      >
        ...
        >
          <div style={{
            ...
            <h1 style={{ margin: 0, fontSize: fontSize * 1.5, color: "#fafafa" }}>Transform3D API</h1>
            <p style={{ margin: `${rect.vmin * 2}px 0 0`, fontSize, opacity: 0.95, color: "#c4b5fd" }}>
        ...
        >
          <div style={{
            ...
            borderRadius: `${rect.vmin * 1}px`,
            border: `${rect.vmin * 0.3}px solid #52525b`,
            width: rect.vmin * 45,
            transform: "translateX(-50%)",
          }}>
            <h2 style={{ fontSize, color: "#c4b5fd", margin: `0 0 ${rect.vmin * 2}px` }}>
  ...
  .scaleBy(1.5, 1.5, 1.5)`}
          ...
          >
            <div style={{
              width: cubeSize,
              height: cubeSize,
              border: `${rect.vmin * 1}px solid #c4b5fd`,
  ...
  .rotateY(angle)`}
          ...
          >
            <div style={{
              width: cubeSize,
              height: cubeSize,
              border: `${rect.vmin}px solid #c4b5fd`,
            }} />
          </Element3D>
        ...
        >
          <div style={{
            ...
            <h2 style={{ fontSize, color: "#c4b5fd" }}>
          ...
          >
            <Element3D
              ...
              style={{
                width: cubeSize,
                height: cubeSize,
                border: `${rect.vmin * 0.3}px solid #c4b5fd`,
                transformStyle: "preserve-3d",
              }}
            >
              <Element3D
