...
export function RvePieChart(props: RveBaseProps = {}) {
  const title = pText(props, "title", "Market Share");
  ...
  const segments = [
    { label: "Product A", value: 35, color: primaryColor },
    { label: "Product B", value: 25, color: secondaryColor },
