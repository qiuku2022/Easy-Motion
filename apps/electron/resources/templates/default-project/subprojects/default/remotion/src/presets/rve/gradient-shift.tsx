...
export function RveGradientShift(props: RveBaseProps = {}) {
  const primaryColor = pColor(props, "primaryColor", "#1a1a2e");
  const secondaryColor = pColor(props, "secondaryColor", "#16213e");
  const backgroundColor = pColor(props, "backgroundColor", "#0f3460");
