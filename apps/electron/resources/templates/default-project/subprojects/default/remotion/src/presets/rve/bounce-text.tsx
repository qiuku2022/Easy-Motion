...
export function RveBounceText(props: RveBaseProps = {}) {
  const text = pText(props, "text", "Start Building");
  const subtitle = pText(props, "subtitle", "Theres never been a better time");
