...
export function RveSplitScreen(props: RveBaseProps = {}) {
  const title = pText(props, "title", "Panel A");
  const subtitle = pText(props, "subtitle", "Panel B");
  const primaryColor = pColor(props, "primaryColor", "#1d4ed8");
  const secondaryColor = pColor(props, "secondaryColor", "#7c3aed");
