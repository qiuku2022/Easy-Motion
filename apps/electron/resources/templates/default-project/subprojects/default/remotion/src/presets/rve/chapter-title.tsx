...
export function RveChapterTitle(props: RveBaseProps = {}) {
  const title = pText(props, "title", "1");
  const subtitle = pText(props, "subtitle", "The Beginning");
  const text = pText(props, "text", "Chapter");
