...
export function RveNoiseGrain(props: RveBaseProps = {}) {
  const title = pText(props, "title", "Film Grain Overlay");
  const subtitle = pText(props, "subtitle", "Subtle noise texture effect");
  const backgroundColor = pColor(props, "backgroundColor", "#1a1a2e");
