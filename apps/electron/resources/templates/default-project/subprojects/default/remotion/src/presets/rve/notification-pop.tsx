...
export function RveNotificationPop(props: RveBaseProps = {}) {
  const title = pText(props, "title", "Notifications");
  const text = pText(props, "text", "New Message");
  const subtitle = pText(props, "subtitle", "Hey! Check out this update.");
  ...
  const notifications = [
    { title: text, body: subtitle, color: primaryColor, delay: 0 },
