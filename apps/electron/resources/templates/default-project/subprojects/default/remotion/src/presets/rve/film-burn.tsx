...
export function RveFilmBurn(props: RveBaseProps = {}) {
  const title = pText(props, "title", "Film Burn Effect");
  const subtitle = pText(props, "subtitle", "Light leak overlay");
  const primaryColor = pColor(props, "primaryColor", "#f97316");
