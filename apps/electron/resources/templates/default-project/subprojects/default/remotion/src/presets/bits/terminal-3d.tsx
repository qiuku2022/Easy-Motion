 ...
 * Source: docs/src/bits/examples/scene-3d/Terminal3D.tsx
 */
...
export function BitsTerminal3d(_props: Record<string, unknown> = {}) {
  const rect = useViewportRect();

  // Pre-calculate sizing based on viewport to be responsive
  const termWidth = rect.width * 0.55;
  const termHeight = rect.height * 0.58;
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#09090b", color: "#e4e4e7" }}>
    <Scene3D
      perspective={1000}
