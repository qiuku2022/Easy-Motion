...
export function RveLowerThird(props: RveBaseProps = {}) {
  const title = pText(props, "title", "John Smith");
  const subtitle = pText(props, "subtitle", "Senior Producer");
  ...
  return (
    <div
      style={{
        ...
        width: "100%",
        height: "100%",
        background: `linear-gradient(180deg, ${backgroundColor} 0%, #1f2937 100%)`,
      }}
    >
      <div
        style={{
