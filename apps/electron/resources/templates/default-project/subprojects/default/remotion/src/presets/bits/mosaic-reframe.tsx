 ...
 * Source: docs/src/bits/examples/staggered-motion/MosaicReframe.tsx
 */
...
export function BitsMosaicReframe(_props: Record<string, unknown> = {}) {
              ...
              >
                <div
                  style={{
                    ...
                    background: `linear-gradient(135deg, ${TILE_COLORS[tile.index % TILE_COLORS.length]} 0%, #18181b 100%)`,
                  }}
                />
              </StaggeredMotion>
            );
