...
export function RveProgressBars(props: RveBaseProps = {}) {
  const title = pText(props, "title", "Skills Overview");
  const progress = pNum(props, "progress", 90);
  ...
  const skills = [
    { label: "React", value: 90, color: primaryColor },
