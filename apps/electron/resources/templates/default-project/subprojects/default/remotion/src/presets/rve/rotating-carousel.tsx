...
export function RveRotatingCarousel(props: RveBaseProps = {}) {
  const title = pText(props, "title", "Our Features");
  const text = pCsv(props, "text", ["Feature 1","Feature 2","Feature 3","Feature 4"]);
